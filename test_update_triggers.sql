...
CREATE TABLE IF NOT EXISTS groups (
  ...
  lead_email_import_id NUMERIC,
  lead_api_import_id NUMERIC,
...
INSERT INTO groups(id, transition_state, premium_value, statuses, lead_email_import_id, lead_api_import_id) VALUES
  (1, 'lead', 100, ARRAY['new'],  NULL, NULL),
  (2, 'lead', 100, ARRAY['new'],  7,    NULL);
